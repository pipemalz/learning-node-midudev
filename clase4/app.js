...
app.use(corsMiddleware()) // Middleware para cabeceras CORS, Por defecto asigna '*' a la cabecera Access-Control-Allow-Origin, por lo tanto si queremos limitarlo se mandamos un parametro con los origin permitidos
