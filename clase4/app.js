...
import { validateMovie, validatePartialMovie } from './schemas/moviesSchema.js' // Funcion para validar los datos que se envian a la API utilizando zod

// Forma lenta de leer/importar json
...
const require = createRequire(import.meta.url) // Creamos la constante require pasandole como argumento import.meta.url que es un objeto global el cual tiene informacion de la ruta del proyecto, esto devolvera una funcion que podremos utilizar como el clasico require para importar el json
